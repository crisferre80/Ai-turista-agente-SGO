...
export default function PlaceDetailClient({ place, promotions = [] }: { place: PlaceSerializable; promotions?: Promotion[] }) {
  ...
  return (
    <div style={{ padding: 6, maxWidth: 1000, margin: '0 auto' }}>
      {/* Attraction title header */}
      <header className="text-center pt-10 pb-6 bg-gradient-to-r from-slate-50 via-slate-100 to-slate-50 rounded-lg shadow-md">
        <h1 className="text-5xl font-extrabold text-[#1A3A6C] drop-shadow-lg leading-tight">
          {place.name}
        </h1>
      </header>
